    ...
    <div class="panel panel-default">
		...
		<div class="col-xs-12 col-sm-12 col-md-14">
                    <div class="form-group">
                        ...
                        <select class="form-control input-sm" name="sth">
                                <option>HR</option>
                                    <%
                                        for(int i=0;i<=24;i++)
                                        {
                     ...
                     <select class="form-control input-sm" name="stm">
                                 <option>MIN</option>
                                 <% 
                                    for(int i=0;i<=60;i++)
                                    {
		...
		<div class="col-xs-12 col-sm-12 col-md-14">
                    <div class="form-group">
                        ...
                        <select class="form-control input-sm" name="eth">
                                <option>HR</option>
                                    <%
                                        for(int i=0;i<=24;i++)
                                        {
                     ...
                     <select class="form-control input-sm" name="etm">
                                 <option>MIN</option>
                                 <% 
                                    for(int i=0;i<=60;i++)
                                    {
		...
		<div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control input-sm" type="number" name="day" id="day" placeholder="Day" mini="1" max="31">
                        <input class="form-control input-sm" type="number" name="month" id="month" placeholder="Month" min="1" max="12">
                        <input class="form-control input-sm" type="number" name="year" id="year" placeholder="Year" min="2016" max="9999">
                     </div>
                </div>
